...
fn validate_dictionary_files(model: &crate::core::DataModel, schema_dir: &Path) -> Vec<String> {
...
fn collect_dictionary_file_errors(
    ...
    match gen {
        ...
        crate::core::GeneratorSpec::Unique { inner, .. } => {
            collect_dictionary_file_errors(inner, schema_dir, path, errors);
        }
        crate::core::GeneratorSpec::Conditional {
            branches, default, ..
        } => {
        ...
        crate::core::GeneratorSpec::Composite { generators, .. } => {
...
fn print_schema_summary(model: &crate::core::DataModel) {

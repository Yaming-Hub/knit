...
pub enum GeneratorSpec {
    ...
    /// Lookup a value from a multi-column tuple dictionary.
    ///
    /// The primary column of the tuple is generated by a [`Dictionary`] generator;
    /// this generator reads the primary column's value from the current batch and
    /// maps it to the corresponding value in the specified column of the same
    /// tuple file.
    TupleLookup {
        /// Name of the primary field whose value is already generated.
        source_field: String,
        /// Path to the tuple dictionary file (TSV, same as the primary's dictionary).
        file: String,

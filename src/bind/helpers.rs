...
//! used by [`TemplateSink`](crate::bind::template::TemplateSink). They provide common formatting,
...
///
/// Called by [`TemplateSink::new`](crate::bind::template::TemplateSink::new) during

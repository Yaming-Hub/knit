...
//!
//! All built-in helpers from [`crate::helpers`] are registered automatically.
...
///
/// Created by [`crate::factory::create_sink`] when the format is
/// [`OutputFormat::Template`](crate::factory::OutputFormat::Template), or
